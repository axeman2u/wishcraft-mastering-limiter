...
private:
    ...
    // true-peak-safety work via smooth gain reduction. No longer caps Gain Match
    ...
    // Auto Makeup Gain. Strictly cut-only, targeting unity relative to the raw
    // pre-processing dry/source signal -- see Limiter.h's class-level doc comment for
    // why a later attempt to retarget this toward TP Limit was reverted.
